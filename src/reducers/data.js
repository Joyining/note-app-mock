...
// The reducer function above checks if the action triggered by the component is of type FETCH_NOTES. If it is, then it will update the state of our app with the list of notes that will be fetched by the action.
